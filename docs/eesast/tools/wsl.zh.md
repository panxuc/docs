...
查看方法：按键 ++win+q++（ ++win++ 即 Windows 徽标键），搜索“设置”：
 ...
 ![settings](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/settings.png)

点击“系统”，找到“关于”，即可查看 Windows 版本：

![about](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/about.png)
...
+ 方法二：按 ++win+q++ ，搜索“启用或关闭 Windows 功能”：
  ...
  ![get](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/get.png)

  在里面勾选“适用于 Linux 的 Windows 子系统”：

  ![en](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/en.png)
...
![ubuntu](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/ubuntu.png)
...
![vir](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/vir.png)
...
![b1](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/b1.jpg)

![b2](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/b2.jpg)

![b3](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/b3.jpg)

![b4](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/b4.jpg)
...
![list](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/list.png)
...
![exp](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/exp.png)
...
![imp](https://cdn.jsdelivr.net/gh/eesast/docs@latest/docs/tools/assets/wsl/imp.png)
